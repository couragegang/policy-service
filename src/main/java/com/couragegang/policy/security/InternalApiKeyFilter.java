...
import com.couragegang.policy.api.dto.PolicyModels.ErrorBody;
...
public class InternalApiKeyFilter implements HttpServerFilter {
    ...
    public static final String HEADER = "X-Policy-Internal-Key";

    private final String expectedKey;

    public InternalApiKeyFilter(@Value("${policy-service.internal-api-key}") String expectedKey) {
